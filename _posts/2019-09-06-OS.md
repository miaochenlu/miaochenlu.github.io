...
<img src="/Users/jones/Library/Application Support/typora-user-images/image-20190905134500934.png" width=500>
...
​		单个用户不能总是使得CPU和I/O都很忙

​		组织作业使CPU总有一个作业可以执行

​		如何实现的：操作系统同时将多任务存在内存，选择一个开始执行。该作业可能要等待另一个任务完成，比如I/O，非多道CPU就会空闲，多道程序系统CPU会切换到另一个作业执行，该作业要等待，CPU会切换到另一个作业。只要有一个任务可以执行，CPU就不会空闲
...
​		每个用户在内存中至少有一个程序，装入内存并执行的程序通常称为**进程**，
...
<img src="/Users/jones/Library/Application Support/typora-user-images/image-20190905141213211.png" width=400>
