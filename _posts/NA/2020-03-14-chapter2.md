...
A: $\underset{n\rightarrow \infty}{lim}\frac{|p_{n+1}-p\vert}{\vert p_n-p\vert}=\underset{n\rightarrow \infty}{lim}\frac{\vert g(p_n)-g(p)\vert}{\vert p_n-p\vert}=\underset{n\rightarrow\infty}{lim}\frac{g'(\xi_n)\vert p_n-p\vert}{\vert p_n-p\vert}=\vert g'(p)\vert$ 
