...
A: $\underset{n\rightarrow \infty}{lim}\frac{|p_{n+1}-p|}{|p_n-p|}=\underset{n\rightarrow \infty}{lim}\frac{|g(p_n)-g(p)|}{|p_n-p|}=\underset{n\rightarrow\infty}{lim}\frac{g'(\xi_n)|p_n-p|}{|p_n-p|}=|g'(p)|$ 
