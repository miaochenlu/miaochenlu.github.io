...
<img src="../../assets/images/image-20200616212337227.png" alt="image-20200616212337227" style="zoom:50%;" />

<img src="../../assets/images/lateximg_large.png" alt="lateximg_large" style="zoom:50%;" />

<img src="../../assets/images/image-20200616212710735.png" alt="image-20200616212710735" style="zoom:50%;" />

<img src="../../../assets/images/image_scan-2.jpg" alt="image_scan-2" style="zoom:50%;" />

<img src="../../../assets/images/image_scan.jpg" alt="image_scan" style="zoom:50%;" />

<img src="../../../assets/images/image-20200616213418716.png" alt="image-20200616213418716" style="zoom:50%;" />
...
* Necessary condition: $e^{(k)}\rightarrow\vec{0}$ as $k\rightarrow\infty\Longrightarrow T^k\rightarrow0$
...
$\Rightarrow x^{(k)}=T_{\omega} x^{(k-1)}+c_{\omega}$
...
<img src="../../../assets/images/IMG_5883C958A493-1.jpeg" alt="IMG_5883C958A493-1" style="zoom:50%;" />
...
| i    | $x_i$               | $r_i$                                             | $d_i$                                              |
| ---- | ------------------- | ------------------------------------------------- | -------------------------------------------------- |
| 1    | $(1.2560,1.2121)^T$ | $(5.7\times  10^{-7},3.3715\times  10^{-5})^T$    | $(-0.03220,0.033502)^T$                            |
| 2    | $(1.2238,1.2456)^T$ | $(1.18\times  10^{-6},9\times  10^{-7})^T$        | $(2.285\times  10^{-4},-2.365\times  10^{-4})$     |
| 3    | $(1.2240,1.2454)^T$ | $(-0.682\times  10^{-5},-0.659\times  10^{-5})^T$ | $(0.2717\times  10^{-4},-0.3515\times  10^{-4})^T$ |



hw:

<img src="../../../assets/images/image-20200617131135549.png" alt="image-20200617131135549" style="zoom:50%;" />

<img src="../../../assets/images/image_scan-3.JPG" alt="image_scan-3" style="zoom:50%;" />
