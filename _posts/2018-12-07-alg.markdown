...
<img src="http://miaochenlu.github.io/picture/20190307inductionrbtree.png" width=400>

<img src="http://miaochenlu.github.io/picture/20190307heightrbtree.png" width=400>

<img src="http://miaochenlu.github.io/picture/20190307rotation.png" width=400>
...
```
```c
void TopSort(LGraph Graph, Vertex TopOrder[])
{
    ...
    while(rear != front) {
        int V = queue[front++];
        TopOrder[index++] = V;
        PtrToAdjVNode tmpNode = Graph->G[V].FirstEdge;
        while(tmpNode) {
            Indegree[tmpNode->AdjV]--;
            if(Indegree[tmpNode->AdjV] == 0) queue[rear++] = tmpNode->AdjV;
